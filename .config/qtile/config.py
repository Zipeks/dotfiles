...
groups = [
    ...
    Group("3", label="●", matches=[Match(wm_class="mpv")]),
    Group(
        "4",
        label="●",
        matches=[
    ...
    Group(
        "6",
        label="●",
        matches=[Match(wm_class="gimp"), Match(wm_class="teams-for-linux")],
    ),
    ...
    ScratchPad(
        ...
        [
            DropDown(
                ...
                match=Match(wm_class=re.compile(r"^(Spotify)$")),
                width=0.8,
                height=0.8,
                x=0.1,
                y=0.1,
