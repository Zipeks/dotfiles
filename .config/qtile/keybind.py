...
#  D E F A U L T
    ...
    Key([mod], "F1", lazy.spawn("sh -c ~/.config/picom/picom_togle.sh"), desc='toggle picom'),
...
# C U S T O M
    ...
    Key([mod,"shift"], "v", lazy.spawn('rofi -modi "clipboard:greenclip print" -show clipboard -run-command "{cmd}"'), desc='greenclip'),
